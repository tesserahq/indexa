...
DEFAULT_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/indexa"
DEFAULT_TEST_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/indexa_test"


class Settings(BaseSettings):
    app_name: str = "indexa-api"
    ...
    quore_api_url: str = Field(
        default="https://quore-api.meetindexa.com",
    ...
    nats_queue: Optional[str] = Field(
        default="indexa_worker_all", json_schema_extra={"env": "NATS_QUEUE"}
    )
